...
- Identified and addressed missing data, noting any patterns in the missing data.  

### *Date Analysis*  
- Calculated the average shipping delay for each product category.  

### *Profit Margin Calculation*  
- Created a formula to calculate profit margins for each order, categorizing them as 'High', 'Medium', or 'Low'.  

### *Customer Geographic Analysis*  
- Analyzed the distribution of customers across different cities and countries using Excel functions.  

### *Sales Trend Analysis*  
- Analyzed monthly sales trends and identified peak sales months using date functions.  

### *Top 5 Products*  
- Identified the top 5 products with the highest sales.  

### *Advanced Filtering for High-Risk Deliveries*  
- Used advanced filtering to identify orders with a high risk of late delivery and high sales value.  

### *Product Popularity Index*  
- Developed an index to rate product popularity based on sales volume and frequency.  

### *Dynamic Data Range for Sales Analysis*  
- Created dynamic named ranges for different product categories to calculate total sales.  

### *Order Processing Efficiency*  
- Calculated average processing time for orders and identified the best-performing department.  

### *Customer Loyalty Assessment*  
- Assessed customer loyalty by calculating the average number of orders per customer.  

### *Delivery Status Breakdown by Market*  
- Analyzed the breakdown of delivery status by market regions using a pivot table.  

### *Peak Traffic Time Analysis*  
- Determined peak hours of website traffic and the most viewed products during these times.  

### *Category Popularity by Month*  
- Analyzed which product categories are most popular each month using pivot tables.  

### *User Engagement Analysis*  
- Calculated the average number of product views per IP address to assess user engagement.  

### *Departmental Traffic Analysis*  
- Analyzed which department's products are most frequently accessed using Excel functions.  

### *Most Visited URLs*  
- Identified and ranked the most frequently visited URLs in the dataset.  

### *Product Interest vs. Sales Performance Analysis*  
- Compared product views from the Access Logs dataset with sales data to determine correlation.  

### *Customer Geographic Interest Analysis*  
- Matched customer cities with IP addresses to analyze online engagement compared to actual sales.  

### *Time Series Analysis of Product Interest and Sales*  
- Compared monthly trends in product views with monthly sales trends to identify relationships.  

### *Complex Profit Margin Analysis with Conditional Logic*  
- Developed an advanced formula for profit margins factoring in delivery status and shipping mode.  

### *Predictive Sales Analysis Using Regression*  
- Used Excel's Data Analysis Toolpak to perform regression analysis and predict future sales.  

### *Dynamic Inventory Optimization Model*  
- Created a model to calculate optimal inventory levels based on sales velocity and lead times.  
...
- *Consistent Views*: Steady traffic across mid-day and early evening.  
...
1. *Field & Stream Sportsman 16 Gun Fire Safe*: ₹2.7M  
2. *Perfect Fitness Perfect Rip Deck*: ₹1.7M  
3. *Diamondback Women's Serene Classic Comfort Bike*: ₹1.6M  
4. *Nike Men's Free 5.0+ Running Shoe*: ₹1.4M  
5. *Nike Men's Dri-FIT Victory Golf Polo*: ₹1.2M  
